...
$stocks = [
    [
        "image" => "../images/topics/none.png", 
        "title" => "На данный момент распродажи нет",
        "description" => "Но вы можете оставить заявку на расчет стоимости мебели, и мы свяжемся с вами в ближайшее время."
    ],
    // Добавляйте новые товары для распродажи здесь
...
<head>
    ...
    <meta name="description" content="Распродажа мебели в Томске от компании Art мебель. Выгодные предложения на готовую мебель и мебель под заказ." />
    <meta name="keywords" content="распродажа мебели, скидки мебель, мебель томск, изготовление мебели, скидки на мебель, выгодные предложения мебель" />
    <meta property="og:title" content="Распродажа мебели в г. Томске | Art мебель" />
    <meta property="og:description" content="Большая распродажа мебели в Томске от компании Art мебель. Успейте купить по специальным ценам." />
    ...
    <title>Распродажа мебели в г. Томске | Art мебель</title>
</head>
<body>
                ...
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #2f2f2f;">
                            ...
                            <li><a class="dropdown-item" href="../topics/stock" style="background-color: transparent;">Распродажа</a></li>
                        </ul>
                    </li>
        ...
        <div class="container">
            <div class="row mb-2" id="portfolio">
                <div class="col-lg-7 mx-auto text-center">
                    <h2 class="section-title" style="margin-top: 30px;margin-bottom: 30px;">Распродажа</h2>
                </div>
            </div>
			<div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 mb-5">
            <div class="post-entry">
                <div class="text-center mb-3">
                    <img src="<?= $stock['image']; ?>" alt="Распродажа" class="img-fluid">
                </div>
